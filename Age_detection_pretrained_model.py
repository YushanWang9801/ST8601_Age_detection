...
prototxtPath_age = os.path.sep.join(["./age_detector/age_deploy.prototxt"])
weightsPath_age = os.path.sep.join(["./age_detector/age_net.caffemodel"])
ageNet = cv2.dnn.readNet(prototxtPath_age, weightsPath_age)
